...
function onBackToFrayClick(): void {
...
function renderConfigError(message: string): void {
    ...
    message = `<h2>Error loading Fray</h2><p>${message}</p><p>${contactMsg}</p>`;
...
async function initPage(): Promise<void> {
    ...
    document.getElementById("back_to_element_button")!.onclick = onBackToFrayClick;
